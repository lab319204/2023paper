...
from material1 import welcome_1,prompt_1,prompt_2,prompt_3,prompt_4
...
def get_response(input_text,file_path):
    ...
    client = OpenAI(api_key="sk-127808825e884073bf44902e82c412b1", base_url="https://api.deepseek.com")
...
# 定义阅读材料列表和提示词
reading_material = ["雷雨.pdf","敌人馅饼.pdf","敌人馅饼.pdf","敌人馅饼.pdf"]
file = ["雷雨.txt","敌人馅饼1.txt","敌人馅饼2.txt","敌人馅饼3.txt"]
