...
# 数据来源：肇庆市统计年鉴（2008年-2021年）表3-6 各县（市、区）人口自然变动情况
# 注：为方便进行整合，将各个表的数据粘贴至一个新表（肇庆市人口自然变动情况）中，一个年份的数据为一个sheet
...
#四、写入数据
write.xlsx(list(CombinedSheet = main_data), file = "2008-2021肇庆人口自然变动（面板数据）.xlsx")